...
do
sbatch -e $OUT_DIR/trichocarpa.gene_alpha.MKtest.input.$i.err -o $OUT_DIR/trichocarpa.gene_alpha.MKtest.input.$i.out -J trichocarpa.gene_alpha.MKtest.input.$i.job gene_alpha_input.trichocarpa.sh $i
echo $i
