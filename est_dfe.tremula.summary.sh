...
anno=$1
OutDir="/proj/b2010014/nobackup/population_genetics/DFE/tremula/$anno/summary"
...
#####the real data
Input_real="/proj/b2010014/nobackup/population_genetics/DFE/tremula/$anno/real"
...
for n in {1..200}
do
Input_bootstrap="/proj/b2010014/nobackup/population_genetics/DFE/tremula/$anno/bootstrap/bootstrap$n"
