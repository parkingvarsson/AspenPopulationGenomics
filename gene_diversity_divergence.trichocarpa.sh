...
OutDir="/proj/b2010014/GenomePaper/population_genetics/pan_genome/gene_diversity_divergence/trichocarpa"

four_fold="/proj/b2010014/GenomePaper/population_genetics/pan_genome/ANGSD/trichocarpa/trichocarpa_all/thetas/anno_type/four_fold.filter.vcf"
...
echo -e "Name\t4_fold_pi\t0_fold_df" > $OutDir/trichocarpa.gene.4pi_0df.$1.txt
...
######df,dxy,fst
	...
	echo -e "$name\t$gene_four_fold_pi\t$gene_zero_fold_df" >> $OutDir/trichocarpa.gene.4pi_0df.$1.txt
