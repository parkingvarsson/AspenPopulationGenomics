...
input_rscript="/proj/b2011141/pipeline/R/genomic_adaptation_paper/gatk_hap/fread.summary.tremula.gatk.boot.R"

bootstrap_n=$1
anno="zero_fold"
OutDir="/proj/b2010014/GenomePaper/population_genetics/pan_genome/shared/three_species/$anno/dfe/tremula/bootstrap/bootstrap$bootstrap_n"
