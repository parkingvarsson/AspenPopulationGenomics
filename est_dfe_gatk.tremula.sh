...
input_rscript="/proj/b2011141/pipeline/R/genomic_adaptation_paper/gatk_hap/fread.summary.3species.gatk.R"

Rscript $input_rscript

anno="zero_fold"
OutDir="/proj/b2010014/GenomePaper/population_genetics/pan_genome/shared/three_species/$anno/dfe/tremula/real"
