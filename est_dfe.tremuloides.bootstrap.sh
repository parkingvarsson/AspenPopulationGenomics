...
#SBATCH -p core
#SBATCH -n 2
#SBATCH -o est_dfe.boot.tremuloides.out
#SBATCH -e est_dfe.boot.tremuloides.err
#SBATCH -J est_dfe.boot.tremuloides.job
#SBATCH -t 6:00:00
...
fread_Rscript="/proj/b2011141/pipeline/R/genomic_adaptation_paper/angsd/tremuloides.boot.DFE_input.R"


for file in {zero_fold,intron,intergenic,utr3,utr5} 
do
OutDir="/proj/b2010014/nobackup/population_genetics/DFE/tremuloides/$file/bootstrap/bootstrap$1" ##$1 is the number of bootstrap 
