...
#SBATCH -p core
#SBATCH -n 2
#SBATCH -o est_dfe.boot.tremula.out
#SBATCH -e est_dfe.boot.tremula.err
#SBATCH -J est_dfe.boot.tremula.job
#SBATCH -t 6:00:00
...
fread_Rscript="/proj/b2011141/pipeline/R/genomic_adaptation_paper/angsd/tremula.boot.DFE_input.R"


for file in {zero_fold,intron,intergenic,utr3,utr5} 
do
OutDir="/proj/b2010014/nobackup/population_genetics/DFE/tremula/$file/bootstrap/bootstrap$1" ##$1 is the number of bootstrap 
...
echo "sfs_input_file  $OutDir/tremula.$anno.bootstrap$1.txt" >> $OutDir/est_dfe.${anno}.site_class-0.txt
...
echo "sfs_input_file  $OutDir/tremula.$anno.bootstrap$1.txt" >> $OutDir/est_dfe.${anno}.site_class-1.txt
...
echo "divergence_file  $OutDir/tremula.$anno.bootstrap$1.omega.txt" >> $OutDir/est_dfe.${anno}.alpha_omega.txt
