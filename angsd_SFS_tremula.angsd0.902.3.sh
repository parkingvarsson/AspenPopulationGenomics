...
OutDir="/proj/b2010014/nobackup/population_genetics/tremula/ANGSD/trichocarpa/tremula_${1}_4/$2/"
...
$angsd2 -bam $bam_list_tremula -minMapQ 30 -minQ 20 -GL 1 -doSaf 1 -out $OutDir/tremula_$1.$2 -anc $ref -rf $region -fold 1
