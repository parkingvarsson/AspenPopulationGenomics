...
input_rscript="/proj/b2011141/pipeline/R/genomic_adaptation_paper/gatk_hap/fread.summary.tremuloides.gatk.R"

OutDir="/proj/b2010014/GenomePaper/population_genetics/pan_genome/shared/three_species/zero_fold/dfe/tremuloides/real"
echo $OutDir
if [ ! -d "$OutDir" ]; then
mkdir -p $OutDir
fi
