...
#SBATCH -A b2012141
#SBATCH -p core
#SBATCH -o gene_diversity_divergence.trichocarpa.out
#SBATCH -e gene_diversity_divergence.trichocarpa.err
#SBATCH -J gene_diversity_divergence.trichocarpa.job
#SBATCH -t 1-00:00:00
...
OutDir="/proj/b2010014/GenomePaper/population_genetics/pan_genome/gene_alpha/trichocarpa"
