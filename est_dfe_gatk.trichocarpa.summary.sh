...
anno=$1
OutDir="/proj/b2010014/GenomePaper/population_genetics/pan_genome/dfe/trichocarpa/$anno/summary"

if [ ! -d "$OutDir" ]; then
mkdir -p $OutDir
fi

echo -e "Name\tN2\tt2\tNw\tb\tEs\tf0\tL\tNes_1\tNes_1_10\tNes_10_100\tNes_100\tlambda\tselected_divergence\talpha\tomega_A" > $OutDir/trichocarpa.dfe.$anno.summary

#####the real data
Input_real="/proj/b2010014/GenomePaper/population_genetics/pan_genome/shared/three_species/$anno/dfe/trichocarpa/real"
...
echo -e "real\t$N2\t$t2\t$Nw\t$b\t$Es\t$f0\t$L\t$Nes_1\t$Nes_1_10\t$Nes_10_100\t$Nes_100\t$lambda\t$selected_divergence\t$alpha\t$omega_A" >> $OutDir/trichocarpa.dfe.$anno.summary

###bootstrap

for n in {1..200}
do
Input_bootstrap="/proj/b2010014/GenomePaper/population_genetics/pan_genome/shared/three_species/$anno/dfe/trichocarpa/bootstrap/bootstrap$n"
...
echo -e "bootstrap$n\t$N2\t$t2\t$Nw\t$b\t$Es\t$f0\t$L\t$Nes_1\t$Nes_1_10\t$Nes_10_100\t$Nes_100\t$lambda\t$selected_divergence\t$alpha\t$omega_A" >> $OutDir/trichocarpa.dfe.$anno.summary
done
